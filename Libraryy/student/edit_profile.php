    ...
    <div class="row">
		...
		<div class="col-md-4">
			<form action="update.php" method="post" id= "main_content">
				...
				<div class="form-group">
					<label>USN:</label>
					<input type="text" class="form-control" value="<?php echo $usn;?>" name="usn">
				</div>
				<div class="form-group">
					<label>Branch:</label>
					<input type="text" class="form-control" value="<?php echo $branch;?>" name="branch">
				</div>
				<div class="form-group">
					<label>Semester:</label>
					<input type="text" class="form-control" value="<?php echo $sem;?>" name="sem">
				</div>
                <div class="form-group">
